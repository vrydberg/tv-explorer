...
<template>
  <div class="w-full flex justify-between items-center flex-col px-6">
  
    <div class="w-full max-w-6xl  flex items-center justify-between">

      <h3 class="text-md font-semibold text-white lg:text-lg">Trending</h3>
