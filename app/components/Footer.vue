...
<template>
  <footer class="w-full bg-eigengrau-900 border-t border-border-subtle px-4 py-5 sm:px-6 lg:px-8">
    <div class="w-full mx-auto max-w-7xl">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-5">
          <span class="text-xs text-text-subtle">Data by</span>
          <a
            ...
            class="group"
          >
            <svg class="w-20 opacity-50 group-hover:opacity-80 transition-opacity duration-200" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 423.04 35.4">
              <defs>
                <linearGradient id="tmdb-gradient" y1="17.7" x2="423.04" y2="17.7" gradientUnits="userSpaceOnUse">
          ...
          <span class="text-text-subtle/30">|</span>

          <span class="text-xs text-text-subtle">Built with</span>
          <a
            href="https://nuxt.com/"
            target="_blank"
            rel="noopener noreferrer"
            class="group"
          >
            <svg class="w-12 opacity-50 group-hover:opacity-80 transition-opacity duration-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 32" fill="none">
              <path d="M60.32 32C60.6656 32 60.96 31.7135 60.96 31.36V16.48C60.96 16.48 61.76 17.92 63.2 20.32L69.44 31.04C69.7255 31.6384 70.359 32 70.88 32H75.2V8H70.88C70.5923 8 70.24 8.23906 70.24 8.64V23.68L67.36 18.56L61.6 8.8C61.3197 8.3026 60.7166 8 60.16 8H56V32H60.32Z" fill="currentColor" class="text-text-muted"/>
              <path d="M116.16 14.72H118.24C118.77 14.72 119.2 14.2902 119.2 13.76V9.6H123.68V14.72H128V18.56H123.68V25.44C123.68 27.12 124.489 27.84 125.92 27.84H128V32H125.28C121.592 32 119.2 29.6114 119.2 25.6V18.56H116.16V14.72Z" fill="currentColor" class="text-text-muted"/>
              <path d="M94.56 14.72V24.64C94.56 26.8806 93.7188 28.7695 92.48 30.08C91.2412 31.3905 89.5306 32 87.2 32C84.8694 32 82.9988 31.3905 81.76 30.08C80.5422 28.7695 79.68 26.8806 79.68 24.64V14.72H82.24C82.7859 14.72 83.3231 14.8195 83.68 15.2C84.0369 15.5593 84.16 15.7704 84.16 16.32V24.64C84.16 25.9294 84.2331 26.7259 84.8 27.36C85.3669 27.973 86.0662 28.16 87.2 28.16C88.3548 28.16 88.8731 27.973 89.44 27.36C90.0069 26.7259 90.08 25.9294 90.08 24.64V16.32C90.08 15.7704 90.2031 15.4205 90.56 15.04C90.8736 14.7057 91.2045 14.7136 91.68 14.72C91.7457 14.7209 91.9337 14.72 92 14.72H94.56Z" fill="currentColor" class="text-text-muted"/>
              <path d="M108.16 23.04L113.6 14.72H109.44C108.916 14.72 108.45 14.9081 108.16 15.36L105.6 19.2L103.2 15.52C102.91 15.0681 102.284 14.72 101.76 14.72H97.76L103.2 22.88L97.28 32H101.44C101.96 32 102.429 31.486 102.72 31.04L105.6 26.72L108.64 31.2C108.931 31.646 109.4 32 109.92 32H114.08L108.16 23.04Z" fill="currentColor" class="text-text-muted"/>
