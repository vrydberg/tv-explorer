...
<template>
    ...
    <div class="flex flex-col px-16 py-4 items-center">
        <h1 class="mb-8 text-3xl font-bold leading-none text-eigengrau-100">Start Exploring</h1>
        <input
            v-model="searchValue"
            name="searchInput"
            type="search"
            class="w-full max-w-2xl px-4 py-4 rounded-full text-md font-medium bg-eigengrau-100"
